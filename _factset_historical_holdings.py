...
# etf_symbols = ["SIXA","SXQG","CWS","GK","ATFV","HIDV","LRGC","LOWV","SMRI","CGUS","CGDV","CGGR","EQIN","DUHP","ECML","HUSV","MMLG","DVAL","LRGE","INCE","PGRO","GUSE","GSGO","GVIP","GDIV","HAPI","WINN","BEEZ","FFTY","BOUT","BLCR","BALI","BLCV","JGRO","JAVA","JPEF","JVAL","MDLV","NBDS","BCHP","PSET","USMC","PY","DIVY","TCAF","TGRT","TVAL","TBG","TOLL","DIVZ"]
etf_symbols = ["DIVZ"]
